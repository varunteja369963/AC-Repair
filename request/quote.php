...
try {
    ...
    $mail->Username = 'customercarehyderabad786@gmail.com';                 // SMTP username
    $mail->Password = 'azeemkhan@123';                           // SMTP password
    $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 465;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('customercarehyderabad786@gmail.com', 'Repair Service');
    $mail->addAddress('customercarehyderabad786@gmail.com', 'New Quote');     // Add a recipient            
    $mail->addReplyTo('customercarehyderabad786@gmail.com', 'reply');
