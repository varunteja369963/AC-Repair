!(function (e, t) {
    ...
    function v(e, t, n) {
        ...
        if (((s.text = e), t)) for (o in g) (i = t[o] || (t.getAttribute && t.getAttribute(o))) && s.setAttribute(o, i);
                        ...
                        (r = e[t]),
                            "__proto__" !== t &&
                                ...
                                (c && r && (w.isPlainObject(r) || (o = Array.isArray(r)))
                                    ? ((n = s[t]), (i = o && !Array.isArray(n) ? [] : o || w.isPlainObject(n) ? n : {}), (o = !1), (s[t] = w.extend(c, i, r)))
                                    : void 0 !== r && (s[t] = r));
            return s;
        }),
        w.extend({
            ...
            isPlainObject: function (e) {
                var t, n;
                return !(!e || "[object Object]" !== l.call(e) || ((t = o(e)) && ("function" != typeof (n = f.call(t, "constructor") && t.constructor) || d.call(n) !== p)));
            },
    ...
    var $ = (function (e) {
        ...
        function ae(e, t, r, o) {
            ...
            if (!o && ((t ? t.ownerDocument || t : w) !== p && d(t), (t = t || p), m)) {
                ...
                if (n.qsa && !S[e + " "] && (!y || !y.test(e)) && (1 !== T || "object" !== t.nodeName.toLowerCase())) {
                    if (((g = e), (v = t), 1 === T && U.test(e))) {
                        for ((l = t.getAttribute("id")) ? (l = l.replace(re, oe)) : t.setAttribute("id", (l = x)), a = (h = s(e)).length; a--; ) h[a] = "#" + l + " " + be(h[a]);
                        (g = h.join(",")), (v = (ee.test(e) && ge(t.parentNode)) || t);
                    }
                    try {
        ...
        (d = ae.setDocument = function (e) {
            ...
            return (
                s !== p &&
                    ...
                    (n.matchesSelector = K.test((v = h.matches || h.webkitMatchesSelector || h.mozMatchesSelector || h.oMatchesSelector || h.msMatchesSelector))) &&
                        le(function (e) {
                            (n.disconnectedMatch = v.call(e, "*")), v.call(e, "[s!='']:x"), g.push("!=", W);
                        }),
        ...
        (ae.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== p && d(e), n.matchesSelector && m && !S[t + " "] && (!g || !g.test(t)) && (!y || !y.test(t))))
                try {
                    var r = v.call(e, t);
                        ...
                        : function (t, n, u) {
                              ...
                              if (y) {
                                  ...
                                  if (((h = [s ? y.firstChild : y.lastChild]), s && v)) {
                                      for (
                                          b = (p = (c = (l = (f = (d = y)[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2], d = p && y.childNodes[p];
                                  ...
                                  } else if ((v && (b = p = (c = (l = (f = (d = t)[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && c[1]), !1 === b))
                                      for (
                                          ;
                                          (d = (++p && d && d[m]) || (b = p = 0) || h.pop()) &&
                                          ((a ? d.nodeName.toLowerCase() !== g : 1 !== d.nodeType) || !++b || (v && ((l = (f = d[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [T, b]), d !== t));
                          ...
                          for (; (t = t[r]); )
                              if (1 === t.nodeType || s)
                                  if (((l = (f = t[x] || (t[x] = {}))[t.uniqueID] || (f[t.uniqueID] = {})), o && o === t.nodeName.toLowerCase())) t = t[r] || t;
                                      ...
                                      if ((c = l[i]) && c[0] === T && c[1] === a) return (d[2] = c[2]);
            ...
            return (
                ...
                ce(function (i, s, a, u) {
                    var c,
                        ...
                        y = !e || (!i && t) ? m : Te(m, d, e, a, u),
                        g = n ? (o || (i ? e : h || r) ? [] : s) : y;
                    if ((n && n(y, g, a, u), r)) for (c = Te(g, p), r(c, [], a, u), l = c.length; l--; ) (f = c[l]) && (g[p[l]] = !(y[p[l]] = f));
                    if (i) {
                        if (o || e) {
                            if (o) {
                                for (c = [], l = g.length; l--; ) (f = g[l]) && c.push((y[l] = f));
                                o(null, (g = []), c, u);
                            }
                            for (l = g.length; l--; ) (f = g[l]) && -1 < (c = o ? O(i, f) : d[l]) && (i[c] = !(s[c] = f));
                        }
                    } else (g = Te(g === s ? g.splice(h, g.length) : g)), o ? o(null, s, g, u) : L.apply(s, g);
                })
            );
        }
        function $e(e) {
            for (
                ...
                if ((n = r.relative[e[u].type])) d = [xe(we(d), n)];
                    ...
                    if ((n = r.filter[e[u].type].apply(null, e[u].matches))[x]) {
                        ...
                        return ke(1 < u && we(d), 1 < u && be(e.slice(0, u - 1).concat({ value: " " === e[u - 2].type ? "*" : "" })).replace(F, "$1"), n, u < o && $e(e.slice(u, o)), o < i && $e((e = e.slice(o))), o < i && be(e));
                    }
                    d.push(n);
                }
            return we(d);
        ...
        return (
            ...
            (s = ae.tokenize = function (e, t) {
                ...
                for (a = e, u = [], c = r.preFilter; a; ) {
                    for (s in ((n && !(o = _.exec(a))) || (o && (a = a.slice(o[0].length) || a), u.push((i = []))),
                    (n = !1),
                    (o = z.exec(a)) && ((n = o.shift()), i.push({ value: n, type: o[0].replace(F, " ") }), (a = a.slice(n.length))),
                    r.filter))
                        !(o = G[s].exec(a)) || (c[s] && !(o = c[s](o))) || ((n = o.shift()), i.push({ value: n, type: s, matches: o }), (a = a.slice(n.length)));
                    if (!n) break;
                }
            ...
            (a = ae.compile = function (e, t) {
                var n,
                    ...
                    y = E[e + " "];
                if (!y) {
                    for (t || (t = s(e)), n = t.length; n--; ) (y = $e(t[n]))[x] ? f.push(y) : h.push(y);
                    (y = E(
                        e,
                        ((o = h),
                        (a = 0 < (i = f).length),
                        ...
                        (l = function (e, t, n, s, l) {
                            var f,
                                ...
                                C = k.length;
                            for (l && (c = t === p || t || l); v !== C && null != (f = k[v]); v++) {
                                if (u && f) {
                                    for (h = 0, t || f.ownerDocument === p || (d(f), (n = !m)); (y = o[h++]); )
                                        if (y(f, t || p, n)) {
                                            s.push(f);
                                            break;
                                        }
                                ...
                                a && ((f = !y && f) && g--, e && b.push(f));
                            }
                            if (((g += v), a && v !== g)) {
                                for (h = 0; (y = i[h++]); ) y(b, x, t, n);
                                if (e) {
                                    if (0 < g) for (; v--; ) b[v] || x[v] || (x[v] = j.call(s));
                                    x = Te(x);
                                }
                                L.apply(s, x), l && !e && 0 < x.length && 1 < g + i.length && ae.uniqueSort(s);
                            }
                            return l && ((T = $), (c = w)), b;
                        }),
                        a ? ce(l) : l)
            ...
            (u = ae.select = function (e, t, n, o) {
                ...
                return (d || a(e, p))(o, t, !m, n, !t || (ee.test(e) && ge(t.parentNode)) || t), n;
            }),
    ...
    (w.find = $), (w.expr = $.selectors), (w.expr[":"] = w.expr.pseudos), (w.uniqueSort = w.unique = $.uniqueSort), (w.text = $.getText), (w.isXMLDoc = $.isXML), (w.contains = $.contains), (w.escapeSelector = $.escape);
    ...
    ((w.fn.init = function (e, t, n) {
        ...
        if (((n = n || j), "string" == typeof e)) {
            ...
            if (o[1]) {
                if (((t = t instanceof w ? t[0] : t), w.merge(this, w.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : r, !0)), A.test(o[1]) && w.isPlainObject(t))) for (o in t) m(this[o]) ? this[o](t[o]) : this.attr(o, t[o]);
                return this;
            }
        ...
        w.each(
            ...
            function (e, t) {
                w.fn[e] = function (n, r) {
                    ...
                    return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = w.filter(r, o)), 1 < this.length && (H[e] || w.uniqueSort(o), L.test(e) && o.reverse()), this.pushStack(o);
                };
            }
        );
    var P = /[^\x20\t\r\n\f]+/g;
    ...
    (w.Callbacks = function (e) {
        ...
        var r,
            ...
            c = -1,
            l = function () {
                for (s = s || e.once, i = r = !0; u.length; c = -1) for (o = u.shift(); ++c < a.length; ) !1 === a[c].apply(o[0], o[1]) && e.stopOnFalse && ((c = a.length), (o = !1));
            ...
            f = {
                add: function () {
                    return (
                        a &&
                            (o && !r && ((c = a.length - 1), u.push(o)),
                            (function t(n) {
                                w.each(n, function (n, r) {
                                    m(r) ? (e.unique && f.has(r)) || a.push(r) : r && r.length && "string" !== b(r) && t(r);
                                });
                            })(arguments),
                            o && !r && l()),
                        this
        ...
        w.extend({
                ...
                var n = [
                    ...
                    o = {
                        ...
                        then: function (t, r, o) {
                                        ...
                                        c = function () {
                                            ...
                                            if (!(t < i)) {
                                                ...
                                                (c = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    m(c)
                                                        ? o
                                                            ? c.call(e, s(i, n, R, o), s(i, n, M, o))
                                                            : (i++, c.call(e, s(i, n, R, o), s(i, n, M, o), s(i, n, R, n.notifyWith)))
                                                        : (r !== R && ((a = void 0), (u = [e])), (o || n.resolveWith)(a, u));
                                            }
                                        },
                                        l = o
                                            ? c
                            ...
                            return w
                                .Deferred(function (e) {
                                    n[0][3].add(s(0, e, m(o) ? o : R, e.notifyWith)), n[1][3].add(s(0, e, m(t) ? t : R)), n[2][3].add(s(0, e, m(r) ? r : M));
                                })
                                .promise();
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (t <= 1 && (I(e, s.done(a(n)).resolve, s.reject, !t), "pending" === s.state() || m(o[n] && o[n].then))) return s.then();
    ...
    var _ = function (e, t, n, r, o, i, s) {
            var a = 0,
                u = e.length,
                c = null == n;
            if ("object" === b(n)) for (a in ((o = !0), n)) _(e, t, a, n[a], !0, i, s);
            else if (
                void 0 !== r &&
                ((o = !0),
                m(r) || (s = !0),
    ...
    function ce(e, t, n, r) {
        ...
        if (l && l[3] !== c) {
            for (u /= 2, c = c || l[3], l = +u || 1; s--; ) w.style(e, t, l + c), (1 - i) * (1 - (i = a() / u || 0.5)) <= 0 && (s = 0), (l /= i);
    ...
    var le = {};
    function fe(e, t) {
        for (var n, r, o, i, s, a, u, c = [], l = 0, f = e.length; l < f; l++)
            (r = e[l]).style &&
                ((n = r.style.display),
                t
                    ? ("none" === n && ((c[l] = Q.get(r, "display") || null), c[l] || (r.style.display = "")),
                      "" === r.style.display &&
                          ae(r) &&
                          (c[l] =
                              ((u = s = i = void 0),
                              (s = (o = r).ownerDocument),
                              (a = o.nodeName),
                              (u = le[a]) || ((i = s.body.appendChild(s.createElement(a))), (u = w.css(i, "display")), i.parentNode.removeChild(i), "none" === u && (u = "block"), (le[a] = u)))))
        ...
        for (var i, s, a, u, c, l, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++)
            if ((i = e[p]) || 0 === i)
                if ("object" === b(i)) w.merge(d, i.nodeType ? [i] : i);
                    ...
                    for (s = s || f.appendChild(t.createElement("div")), a = (pe.exec(i) || ["", ""])[1].toLowerCase(), u = me[a] || me._default, s.innerHTML = u[1] + w.htmlPrefilter(i) + u[2], l = u[0]; l--; ) s = s.lastChild;
                    w.merge(d, s.childNodes), ((s = f.firstChild).textContent = "");
                } else d.push(t.createTextNode(i));
        for (f.textContent = "", p = 0; (i = d[p++]); )
            if (r && -1 < w.inArray(i, r)) o && o.push(i);
            else if (((c = ie(i)), (s = ye(f.appendChild(i), "script")), c && ge(s), n)) for (l = 0; (i = s[l++]); ) he.test(i.type || "") && n.push(i);
        return f;
    }
              ...
              w.event.add(e, t, {
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[t]) {
                          ...
                          else if (((s = i.call(arguments)), Q.set(this, t, s), (r = n(this, t)), this[t](), s !== (o = Q.get(this, t)) || r ? Q.set(this, t, !1) : (o = {}), s !== o))
    ...
    (w.event = {
                ...
                for (
                    ...
                    (p = m = (a = $e.exec(t[c]) || [])[1]),
                        ...
                        p &&
                            ...
                            (f = w.event.special[p] || {}),
                            (l = w.extend({ type: p, origType: m, data: r, handler: n, guid: n.guid, selector: o, needsContext: o && w.expr.match.needsContext.test(o), namespace: h.join(".") }, i)),
                            (d = u[p]) || (((d = u[p] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(e, r, h, s)) || (e.addEventListener && e.addEventListener(p, s))),
        ...
        remove: function (e, t, n, r, o) {
            ...
            if (y && (u = y.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--; )
                    if (((p = m = (a = $e.exec(t[c]) || [])[1]), (h = (a[2] || "").split(".").sort()), p)) {
                        for (f = w.event.special[p] || {}, d = u[(p = (r ? f.delegateType : f.bindType) || p)] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = i = d.length; i--; )
                            (l = d[i]),
                                (!o && m !== l.origType) ||
                                    (n && n.guid !== l.guid) ||
                        ...
                        s && !d.length && ((f.teardown && !1 !== f.teardown.call(e, h, y.handle)) || w.removeEvent(e, p, y.handle), delete u[p]);
            ...
            if (((a.delegateTarget = this), !l.preDispatch || !1 !== l.preDispatch.call(this, a))) {
                for (s = w.event.handlers.call(this, a, c), t = 0; (o = s[t++]) && !a.isPropagationStopped(); )
                    for (a.currentTarget = o.elem, n = 0; (i = o.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        (a.rnamespace && !1 !== i.namespace && !a.rnamespace.test(i.namespace)) ||
                            ((a.handleObj = i), (a.data = i.data), void 0 !== (r = ((w.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u)) && !1 === (a.result = r) && (a.preventDefault(), a.stopPropagation()));
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && N(t, "input") && Ae(t, "click", Ce), !1;
                },
                trigger: function (e) {
                    var t = this || e;
    ...
    function Re(e, t) {
        var n, r, o, i, s, a, u, c;
        if (1 === t.nodeType) {
            if (Q.hasData(e) && ((i = Q.access(e)), (s = Q.set(t, i)), (c = i.events))) for (o in (delete s.handle, (s.events = {}), c)) for (n = 0, r = c[o].length; n < r; n++) w.event.add(t, o, c[o][n]);
    ...
    function Me(e, t, n, r) {
        ...
        var o,
            ...
            y = t[0],
            g = m(y);
        if (g || (1 < d && "string" == typeof y && !h.checkClone && qe.test(y)))
            return e.each(function (o) {
                var i = e.eq(o);
                g && (t[0] = y.call(this, o, i.html())), Me(i, t, n, r);
            });
        if (d && ((i = (o = we(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === o.childNodes.length && (o = i), i || r)) {
            for (u = (a = w.map(ye(o, "script"), Oe)).length; f < d; f++) (c = o), f !== p && ((c = w.clone(c, !0, !0)), u && w.merge(a, ye(c, "script"))), n.call(e[f], c, f);
            if (u)
                for (l = a[a.length - 1].ownerDocument, w.map(a, Pe), f = 0; f < u; f++)
                    (c = a[f]),
                        he.test(c.type || "") &&
                            !Q.access(c, "globalEval") &&
                            w.contains(l, c) &&
                            (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }) : v(c.textContent.replace(Le, ""), c, l));
        }
        return e;
    }
    function Ie(e, t, n) {
        for (var r, o = t ? w.filter(t, e) : e, i = 0; null != (r = o[i]); i++) n || 1 !== r.nodeType || w.cleanData(ye(r)), r.parentNode && (n && ie(r) && ge(ye(r, "script")), r.parentNode.removeChild(r));
        return e;
    }
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(h.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e)))
                for (s = ye(l), r = 0, o = (i = ye(e)).length; r < o; r++)
                    (a = i[r]), "input" === (c = (u = s[r]).nodeName.toLowerCase()) && de.test(a.type) ? (u.checked = a.checked) : ("input" !== c && "textarea" !== c) || (u.defaultValue = a.defaultValue);
            if (t)
                if (n) for (i = i || ye(e), s = s || ye(l), r = 0, o = i.length; r < o; r++) Re(i[r], s[r]);
                else Re(e, l);
            return 0 < (s = ye(l, "script")).length && ge(s, !f && ye(e, "script")), l;
        },
    ...
    function _e(e, t, n) {
        ...
        return (
            (n = n || Be(e)) &&
                ("" !== (s = n.getPropertyValue(t) || n[t]) || ie(e) || (s = w.style(e, t)),
                !h.pixelBoxStyles() && We.test(s) && Fe.test(t) && ((r = a.width), (o = a.minWidth), (i = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = r), (a.minWidth = o), (a.maxWidth = i))),
            void 0 !== s ? s + "" : s
        );
    }
    function ze(e, t) {
    ...
    function et(e, t, n, r, o, i) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (u += w.css(e, n + re[s], !0, o)),
                r
                    ? ("content" === n && (u -= w.css(e, "padding" + re[s], !0, o)), "margin" !== n && (u -= w.css(e, "border" + re[s] + "Width", !0, o)))
                    : ((u += w.css(e, "padding" + re[s], !0, o)), "padding" !== n ? (u += w.css(e, "border" + re[s] + "Width", !0, o)) : (a += w.css(e, "border" + re[s] + "Width", !0, o)));
        return !r && 0 <= i && (u += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - i - u - a - 0.5)) || 0), u;
    }
    function tt(e, t, n) {
        var r = Be(e),
        ...
        return (
            ((!h.boxSizingReliable() && o) || "auto" === s || (!parseFloat(s) && "inline" === w.css(e, "display", !1, r))) && e.getClientRects().length && ((o = "border-box" === w.css(e, "boxSizing", !1, r)), (i = a in e) && (s = e[a])),
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (i = typeof n) && (o = ne.exec(n)) && o[1] && ((n = ce(e, t, o)), (i = "number")),
                    null != n &&
                        n == n &&
                        ("number" !== i || u || (n += (o && o[3]) || (w.cssNumber[a] ? "" : "px")),
            ...
            w.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    var o,
                        ...
                        u = r ? et(e, t, r, a, i) : 0;
                    return (
                        a && s && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - et(e, t, "border", !1, i) - 0.5)),
                ...
                return _(
                    ...
                    function (e, t, n) {
                        var r,
                            ...
                            s = 0;
                        if (Array.isArray(t)) {
                            for (r = Be(e), o = t.length; s < o; s++) i[t[s]] = w.css(e, t[s], !1, r);
                            return i;
                        }
    ...
    function pt(e, t, n) {
        ...
        for (
            ...
            if ((r = pt.prefilters[i].call(c, e, l, c.opts))) return m(r.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
        return (
            w.map(l, dt, c),
            ...
            function (e, t, n) {
                ...
                if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(p))
                    for (r in (f &&
                        ...
                        "none" === (l = w.css(e, "display")) && (c ? (l = c) : (fe([e], !0), (c = e.style.display || c), (l = w.css(e, "display")), fe([e]))),
                    ...
                    p))
                        u ||
                            (y ? "hidden" in y && (m = y.hidden) : (y = Q.access(e, "fxshow", { display: c })),
                            i && (y.hidden = !m),
                            m && fe([e], !0),
                            d.done(function () {
                                for (r in (m || fe([e]), Q.remove(e, "fxshow"), p)) w.style(e, r, p[r]);
                            })),
                            (u = dt(m ? y[r] : 0, r, d)),
                            r in y || ((y[r] = u.start), m && ((u.end = u.start), (u.start = 0)));
            },
        ],
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i)
                    return void 0 === e.getAttribute
                        ? w.prop(e, t, n)
                        : ((1 === i && w.isXMLDoc(e)) || (o = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? ht : void 0)),
                          void 0 !== n
                              ? null === n
        ...
        w.fn.extend({
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && r
                    ...
                    : this.each(function () {
                          var t, o, i, s;
                          if (r) for (o = 0, i = w(this), s = xt(e); (t = s[o++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            ...
            hasClass: function (e) {
                var t,
                    n,
                    r = 0;
                for (t = " " + e + " "; (n = this[r++]); ) if (1 === n.nodeType && -1 < (" " + vt(bt(n)) + " ").indexOf(t)) return !0;
                return !1;
            },
        });
    var wt = /\r/g;
    ...
    w.extend(w.event, {
        trigger: function (t, n, o, i) {
            ...
            if (
                ...
                if (!i && !p.noBubble && !y(o)) {
                    for (c = p.delegateType || v, Tt.test(c + v) || (a = a.parentNode); a; a = a.parentNode) g.push(a), (u = a);
                    u === (o.ownerDocument || r) && g.push(u.defaultView || u.parentWindow || e);
                }
                for (s = 0; (a = g[s++]) && !t.isPropagationStopped(); )
                    (h = a),
                        (t.type = 1 < s ? c : p.bindType || v),
                        (d = (Q.get(a, "events") || {})[t.type] && Q.get(a, "handle")) && d.apply(a, n),
                        (d = l && a[l]) && d.apply && G(a) && ((t.result = d.apply(a, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = v),
                    i ||
                        ...
                        (l &&
                            ...
                            ((u = o[l]) && (o[l] = null),
                            (w.event.triggered = v),
                            t.isPropagationStopped() && h.addEventListener(v, kt),
                            o[v](),
                            t.isPropagationStopped() && h.removeEventListener(v, kt),
    ...
    (Bt.href = $t.href),
        w.extend({
            ...
            ajax: function (t, n) {
                ...
                var o,
                    ...
                    h = w.ajaxSetup({}, n),
                    m = h.context || h,
                    y = h.context && (m.nodeType || m.jquery) ? w(m) : w.event,
                    g = w.Deferred(),
                ...
                if (
                    (g.promise($),
                    (h.url = ((t || h.url || $t.href) + "").replace(Rt, $t.protocol + "//")),
                ...
                if ((h.data && h.processData && "string" != typeof h.data && (h.data = w.param(h.data, h.traditional)), _t(Mt, h, n, $), l)) return $;
                ...
                h.hasContent
                    ...
                    : ((p = h.url.slice(i.length)),
                      h.data && (h.processData || "string" == typeof h.data) && ((i += (Et.test(i) ? "&" : "?") + h.data), delete h.data),
                      !1 === h.cache && ((i = i.replace(Ht, "$1")), (p = (Et.test(i) ? "&" : "?") + "_=" + Ct++ + p)),
                      (h.url = i + p)),
                h.ifModified && (w.lastModified[i] && $.setRequestHeader("If-Modified-Since", w.lastModified[i]), w.etag[i] && $.setRequestHeader("If-None-Match", w.etag[i])),
                ((h.data && h.hasContent && !1 !== h.contentType) || n.contentType) && $.setRequestHeader("Content-Type", h.contentType),
                $.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : h.accepts["*"]),
                h.headers))
                    $.setRequestHeader(d, h.headers[d]);
                if (h.beforeSend && (!1 === h.beforeSend.call(m, $, h) || l)) return $.abort();
                if (((k = "abort"), v.add(h.complete), $.done(h.success), $.fail(h.error), (o = _t(It, h, n, $)))) {
                    if ((($.readyState = 1), f && y.trigger("ajaxSend", [$, h]), l)) return $;
                    h.async &&
                        0 < h.timeout &&
                ...
                function C(t, n, r, a) {
                    ...
                    l ||
                        ...
                        c
                            ? (h.ifModified && ((T = $.getResponseHeader("Last-Modified")) && (w.lastModified[i] = T), (T = $.getResponseHeader("etag")) && (w.etag[i] = T)),
                              204 === t || "HEAD" === h.type ? (k = "nocontent") : 304 === t ? (k = "notmodified") : ((k = x.state), (d = x.data), (c = !(p = x.error))))
                            : ((p = k), (!t && k) || ((k = "error"), t < 0 && (t = 0))),
                        ($.status = t),
                        ($.statusText = (n || k) + ""),
                        c ? g.resolveWith(m, [d, k, $]) : g.rejectWith(m, [$, k, p]),
                        $.statusCode(b),
                        (b = void 0),
                        f && y.trigger(c ? "ajaxSuccess" : "ajaxError", [$, h, c ? d : p]),
                        v.fireWith(m, [$, k]),
                        f && (y.trigger("ajaxComplete", [$, h]), --w.active || w.event.trigger("ajaxStop")));
                }
                return $;
            },
        ...
        w.each(["get", "post"], function (e, t) {
            w[t] = function (e, n, r, o) {
                return m(n) && ((o = o || r), (r = n), (n = void 0)), w.ajax(w.extend({ url: e, type: t, dataType: o, data: n, success: r }, w.isPlainObject(e) && e));
            };
        }),
                            ...
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : i(Ut[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
                            };
                        }),
                            (a.onload = n()),
    ...
    w.ajaxSetup({
        ...
        w.ajaxPrefilter("json jsonp", function (t, n, r) {
            ...
            if (a || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    a ? (t[a] = t[a].replace(Yt, "$1" + o)) : !1 !== t.jsonp && (t.url += (Et.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
                    ...
                    r.always(function () {
                        void 0 === i ? w(e).removeProp(o) : (e[o] = i), t[o] && ((t.jsonpCallback = n.jsonpCallback), Gt.push(o)), s && m(i) && i(s[0]), (s = i = void 0);
                    }),
                    "script"
                );
        }),
        (h.createHTMLDocument = (((Vt = r.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Vt.childNodes.length)),
        (w.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (s = !n && []),
                  (i = A.exec(e)) ? [t.createElement(i[1])] : ((i = we([e], t, s)), s && s.length && w(s).remove(), w.merge([], i.childNodes)));
            var o, i, s;
        }),
        (w.fn.load = function (e, t, n) {
            var r,
                ...
                a = e.indexOf(" ");
            return (
                -1 < a && ((r = vt(e.slice(a))), (e = e.slice(0, a))),
        ...
        (w.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === c && (e.style.position = "relative"),
                    ...
                    (i = w.css(e, "top")),
                    (u = w.css(e, "left")),
                    ("absolute" === c || "fixed" === c) && -1 < (i + u).indexOf("auto") ? ((s = (r = l.position()).top), (o = r.left)) : ((s = parseFloat(i) || 0), (o = parseFloat(u) || 0)),
    ...
    $(document).ready(function () {
        $(window).resize(function () {
            $(window).width() > 750 && ($("#mobile-menu").css("display", "none"), $("#mobile-body-overly").css("display", "none"), $("#close-nav").css("display", "none"));
        }),
            $("#menu-icon").click(function () {
                $(window).width() <= 750 && ($("#mobile-menu").css("display", "block"), $("#mobile-body-overly").css("display", "block"), $("#close-nav").css("display", "block"));
            }),
    ...
    $(document).ready(function () {
        $("input:radio").prop("checked", !1),
            $("input:radio").each(function () {
                if ($(this).data("appliance")) {
                    $(this).prop("checked", !0);
                    var e = $(this).data("appliance");
                    $("#sub-category").css("display", "block"), $("#" + e).css("display", "block");
                }
            }),
            $(document).find("#mobile-no-box").val(""),
            $(document).find("#customer-email").val(""),
            $(document).find("#message").val(""),
            $(document).find("#connect-input").val(""),
            $(document).find("#mobile-no-box-mobile").val(""),
            $(document).find("#customer-email-mobile").val(""),
            $(document).find("#message-mobile").val(""),
            $(document).find("#connect-input-mobile").val("");
    }),
    $(document).ready(function () {
        $(document).on("click", "#wm-radio", function () {
            $("#sub-category").css("display", "table-row"), $("#wm").css("display", "block"), $("#ref").css("display", "none"), $("#mo").css("display", "none"), $("#ac").css("display", "none");
        }),
            $(document).on("click", "#ref-radio", function () {
                $("#sub-category").css("display", "table-row"), $("#wm").css("display", "none"), $("#ref").css("display", "block"), $("#mo").css("display", "none"), $("#ac").css("display", "none");
            }),
            $(document).on("click", "#mo-radio", function () {
                $("#sub-category").css("display", "table-row"), $("#wm").css("display", "none"), $("#ref").css("display", "none"), $("#mo").css("display", "block"), $("#ac").css("display", "none");
            }),
            $(document).on("click", "#ac-radio", function () {
                $("#sub-category").css("display", "table-row"), $("#wm").css("display", "none"), $("#ref").css("display", "none"), $("#mo").css("display", "none"), $("#ac").css("display", "block");
            });
    }),
    $(document).ready(function () {
        $(document).on("input change paste", "#mobile-no-box", function () {
            var e = $(this)
                .val()
                .replace(/[^0-9]/g, "");
            $(this).val(e);
    ...
    $(document).ready(function () {
        $(document).on("input change paste", "#connect-input", function () {
            var e = $(this)
                .val()
                .replace(/[^0-9]/g, "");
            $(this).val(e);
    ...
    $(document).ready(function () {
        $(document).on("click", "#submit-query", function () {
            var e;
            if ("" == (o = $(document).find("#mobile-no-box").val()) || o.length < 1)
                return (
                    $("#mobile-no-ack").html("Please enter your mobile number."), document.getElementById("mobile-no-ack").scrollIntoView(), ((e = $("#mobile-no-ack").offset()).top -= 200), $("html, body").animate({ scrollTop: e.top }), !1
                );
            if (10 !== o.length)
                return (
                    $("#mobile-no-ack").html("Please enter valid mobile number."), document.getElementById("mobile-no-ack").scrollIntoView(), ((e = $("#mobile-no-ack").offset()).top -= 200), $("html, body").animate({ scrollTop: e.top }), !1
                );
            var t = "",
                n = $("input[type='radio']:checked").val();
            "wm" == n ? (t = "washing-machine") : "ref" == n ? (t = "refrigerator") : "mo" == n ? (t = "microwave-oven") : "ac" == n && (t = "air-conditioner");
            var r = $("#" + n)
                    .find(":selected")
                    .text(),
                o = $("#mobile-no-box").val(),
                i = $(location).attr("href");
                var utm_source = utm(utm_source);
                var utm_medium = utm(utm_medium);
                var utm_network = utm(utm_network);
                var utm_campaign = utm(utm_campaign);
                var utm_adgroup = utm(utm_adgroup);
                var utm_keyword = utm(utm_keyword);
                
            $.ajax({
                type: "POST",
                url: "https://ac-customer-care.in/request/quote.php",
                data: { appliance: t, problem: r, mobile: o, brand: "acrepair", path: i },
                success: function (e) {
                    $.ajax({
                        type: "POST",
                        url: "https://ac-customer-care.in/request/data-new/send.php",
                        data: { appliance: t, problem: r, mobile: o, brand: "acrepair", path: i, utm_source: utm_source, utm_medium: utm_medium, utm_network: utm_network, utm_campaign: utm_campaign, utm_adgroup: utm_adgroup, utm_keyword: utm_keyword},
                        success: function (e) {
                            alert(e);
                            $.trim(e), window.open("https://ac-customer-care.in/redirect/thankyou.php", "_blank");
                        }
                    });
                },
            });
    ...
    $(document).ready(function () {
        $(document).on("click", "#wm-radio-mobile", function () {
            $("#sub-category-mobile").css("display", "table-row"), $("#wm-mobile").css("display", "block"), $("#ref-mobile").css("display", "none"), $("#mo-mobile").css("display", "none"), $("#ac-mobile").css("display", "none");
        }),
            $(document).on("click", "#ref-radio-mobile", function () {
                $("#sub-category-mobile").css("display", "table-row"), $("#wm-mobile").css("display", "none"), $("#ref-mobile").css("display", "block"), $("#mo-mobile").css("display", "none"), $("#ac-mobile").css("display", "none");
            }),
            $(document).on("click", "#mo-radio-mobile", function () {
                $("#sub-category-mobile").css("display", "table-row"), $("#wm-mobile").css("display", "none"), $("#ref-mobile").css("display", "none"), $("#mo-mobile").css("display", "block"), $("#ac-mobile").css("display", "none");
            }),
            $(document).on("click", "#ac-radio-mobile", function () {
                $("#sub-category-mobile").css("display", "table-row"), $("#wm-mobile").css("display", "none"), $("#ref-mobile").css("display", "none"), $("#mo-mobile").css("display", "none"), $("#ac-mobile").css("display", "block");
            });
    }),
    $(document).ready(function () {
        $(document).on("click", "#submit-query-mobile", function () {
            if ("" == (r = $(document).find("#mobile-no-box-mobile").val()) || r.length < 1) return $("#mobile-no-ack-mobile").html("Please enter your mobile number."), !1;
            if (10 !== r.length) return $("#mobile-no-ack-mobile").html("Please enter valid mobile number."), !1;
            var e = "",
                t = $("input[type='radio']:checked").val();
            "wm" == t ? (e = "washing-machine") : "ref" == t ? (e = "refrigerator") : "mo" == t ? (e = "microwave-oven") : "ac" == t && (e = "air-conditioner");
            var n = $("#" + t + "-mobile")
                    .find(":selected")
                    .text(),
                r = $("#mobile-no-box-mobile").val(),
                o = $(location).attr("href");
            $.ajax({
                type: "POST",
                url: "https://ac-customer-care.in/request/quote.php",
                data: { appliance: e, problem: n, mobile: r, brand: "acrepair", path: o },
                success: function (e) {
                    $.trim(e), window.open("https://ac-customer-care.in/redirect/thankyou.php", "_blank");
                },
            });
    ...
    $(document).ready(function () {
        $("#connect-button").click(function () {
            var e = $("#connect-input").val();
            if ("" == e || e.length < 1) return $("#connect-form-ack").html("Please enter your mobile number."), !1;
            if ("" == e || e.length < 10) return $("#connect-form-ack").html("Please enter valid mobile number."), !1;
            var t = $(location).attr("href");
            $.ajax({
                type: "POST",
                url: "https://ac-customer-care.in/request/connect.php",
                data: { mobile: e, brand: "acrepair", path: t },
                success: function (e) {
                    $.trim(e), $("#modal-box-section").css("display", "block");
                },
            });
        });
    }),
    $(document).ready(function () {
        $(document).on("click", ".close-popup", function () {
            $("#modal-box-section").css("display", "none"), location.reload();
        });
    }),
    $(document).ready(function () {
    ...
    $(document).ready(function () {
        $("#ac-radio-mobile").prop("checked", !0), $("input[name=prdouct][value=ac]").attr("checked", "checked");
    });
